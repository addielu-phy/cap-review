...
function viewLogin() {
  ...
  app.innerHTML = `
    <div class="brand"><div class="logo">${QUIZ_META.logo || "理"}</div>
      <div><h1>${QUIZ_META.appName || "自學評量"}</h1>
    ...
    <div class="foot"><a href="../index.html">← 回會考複習首頁</a>　｜　<a href="teacher.html">老師後台</a><br>
      題目來源：國中教育會考官方公開歷屆試題，僅供自學練習。<br>成績資料儲存在本機瀏覽器，清除瀏覽資料會一併刪除。</div>
  `;
