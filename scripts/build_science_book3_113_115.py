...
SELECTED = [
    ...
    (114, 7, "第1章 基本測量與科學探究", "要反駁「只有端午節正午才能立蛋」，應只改變日期並讓其他條件盡量相同。同種生雞蛋在聖誕節正午也能立起來即可反駁，答案是 B。"),
    ...
    (114, 38, "第1章 基本測量與科學探究", "把電扇樣品的位置與周圍距離規定得更完整，是增加並固定控制變因，降低位置差異對風速測量的干擾，答案是 C。"),
...
def build() -> dict:
        ...
        questions.append(
            {
                ...
                "images": [relative_asset(year, rel) for rel in source.get("images", [])],
    ...
    quiz = {
        ...
        "scopeAudit": {
            ...
            "sourceYears": {"113": 5, "114": 11, "115": 9},
